...
use Lezhnev74\Jobs\Driver\Mysql\JobHydrator;
...
/**
 * Rows are shaped as `pdo_mysql` delivers them under native prepares: every value a string, `DATETIME(6)` without an
 * offset, and the id already `BIN_TO_UUID`-ed by the select list.
 */
...
final class JobHydratorTest extends TestCase
{
    ...
    private static function row(): array
    {
        return [
            'id' => self::ID,
            'available_at' => '2026-09-11 10:00:00.500000',
            'consumed_till' => null,
            'completed_at' => null,
            'discarded_at' => null,
            'last_abandoned_at' => null,
            'last_stale_ack_at' => null,
            'created_at' => '2026-09-11 09:59:00.000000',
            'updated_at' => '2026-09-11 09:59:30.000000',
            'attempts' => '0',
    ...
    public function testFreshRowAndOffsetLessTimestampsAreReadAsUtc(): void
    {
    ...
    {
        $row = ['consumed_by' => 'w1', 'consumed_till' => '2026-09-11 10:05:00.000000', 'attempts' => '3'] + self::row();
    ...
    public function testSettledRowSurfacesTheLastClaimerRetryInputsAndTelemetry(): void
    {
        $row = [
            'consumed_by' => 'w2',
            'completed_at' => '2026-09-11 10:06:00.000000',
            ...
            'last_abandoned_at' => '2026-09-11 10:03:00.000000',
            'stale_ack_count' => '2',
            'last_stale_ack_by' => 'w1',
            'last_stale_ack_at' => '2026-09-11 10:04:00.000000',
        ] + self::row();
    ...
    {
        $row = ['discarded_at' => '2026-09-11 10:07:00.000000'] + self::row();
    ...
    public static function malformedRows(): iterable
    {
        ...
        yield 'lease without worker' => [['consumed_till' => '2026-09-11 10:05:00.000000']];
    }
